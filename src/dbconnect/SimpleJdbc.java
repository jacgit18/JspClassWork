...
private static PreparedStatement preparedStatement; 
  ...
  public static void main(String[] args)
    ...
    ResultSet resultSet = statement.executeQuery
      ("select firstName, mi, lastName from Students where lastName " + " = 'Jeon'");
    System.out.println("select firstName, mi, lastName from Students where lastName " + " = 'Jeon'");
    ...
    */
    ...
    try {
        ...
        if (rset.next()) {
          ...
          System.out.println(firstName + "Middle name is " + mi +
                  "and last name is " + lastName + " his grade for the course " + title + " is an " +
                  grade);
        }
        else {
